        ...
        <main class="form-registration">
            <form>
              ...
              <div class="form-floating mb-2">
                <input type="text" name="name" class="form-control rounded" id="name" placeholder="name@example.com">
                <label for="name">Name</label>
              </div>
              <div class="form-floating mb-2">
                <input type="text" name="username" class="form-control rounded" id="username" placeholder="name@example.com">
                <label for="username">User name</label>
              </div>
              <div class="form-floating mb-2">
                <input type="email" name="email" class="form-control rounded" id="email" placeholder="name@example.com">
                <label for="email">Email address</label>
              </div>
              <div class="form-floating">
                <input type="password" name="passoword" class="form-control rounded" id="password" placeholder="Password">
